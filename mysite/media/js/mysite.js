     ...
     * This should be renamed to mysiteResetFormFilters
     * 
     * @param form
     * @return
     */
    function mysiteResetFormFilters(form)
    {
	 ...
	 * @param {Object} task
	 */
	function mysiteGridOrdering( order, dir ) 
	{
	 ...
	 * @return
	 */
	function mysiteGridOrder(id, change) 
	{
		var form = document.adminForm;
     ...
     */
    function mysiteFormValidation( url, container, task, form ) 
    {
     ...
     * @return
     */
    function mysiteSubmitForm(task)
    {
	 ...
	 */
	function mysiteDisplayDiv (divname, spanname, showtext, hidetext) { 
	 ...
	 */
	function mysiteSwitchDisplayDiv( prefix, newSuffix )
	{
	...
	function mysiteShowHideDiv(divname)
	{
	 ...
	 */
	function mysiteDoTask( url, container, form, msg ) 
	{
		mysiteNewModal(msg);
		...
		{	
            ...
            var a=new Ajax(url,{
                ...
                onComplete: function(response){
                    ...
                    (function() { document.body.removeChild($('mysiteModal')); }).delay(500);
                    return true;
                }
            }).request();
		}
	...
	function mysiteNewModal (msg)
	{
		...
		var src = 'media/com_mysite/images/ajax-loader.gif';
	 ...
	 * @return string
	 */
	function mysiteGetCheckedValue(radioObj) 
	{
	    if (!radioObj) { return ""; }
