	...
	<table class="adminlist" style="clear: both;">
		<thead>
            <tr>
                ...
                <th style="width: 50px;">
                	<?php echo MysiteGrid::sort( 'ID', "tbl.item_id", @$state->direction, @$state->order ); ?>
                </th>                
                <th style="text-align: left;width: 50%">
                	<?php echo MysiteGrid::sort( 'Sitemap Item', "tbl.title", @$state->direction, @$state->order ); ?>
                </th>
                <th style="width: 100px;">
                	<?php echo MysiteGrid::sort( 'Menu Type', "tbl.menutype", @$state->direction, @$state->order ); ?>
                </th>
                <th style="width: 100px;">
                    <?php echo MysiteGrid::sort( 'Menu Itemid', "tbl.itemid", @$state->direction, @$state->order ); ?>
                </th>
                <th style="width: 100px;">
        ...
        <?php foreach (@$items as $item) : ?>
            <tr class='row<?php echo $k; ?>'>
				...
				<td style="text-align: center;">
					<?php echo MysiteGrid::checkedout( $item, $i, 'item_id' ); ?>
				</td>
				<td style="text-align: center;">
				...
				<td style="text-align: center;">
					<?php echo MysiteGrid::order($item->item_id); ?>
					<?php echo MysiteGrid::ordering($item->item_id, $item->ordering ); ?>
				</td>
				<td style="text-align: center;">
