...
JLoader::register('MysiteQuery', JPATH_ADMINISTRATOR.DS.'components'.DS.'com_mysite'.DS.'library'.DS.'query.php');

class MysiteModelBase extends JModel
{
     ...
     * @since   1.5
     */
    function &getTable($name='', $prefix='MysiteTable', $options = array())
    {
        if (empty($name)) {
            $name = $this->getName();
        }
