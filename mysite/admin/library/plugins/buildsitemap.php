...
JLoader::import( 'com_mysite.library.plugins._base', JPATH_ADMINISTRATOR.DS.'components' );

class MysiteBuildsitemapPlugin extends MysitePluginBase
{
    /**
    ...
    function _getNamespace()
    {
        ...
        $ns = $app->getName().'::'.'com.mysite.buildsitemap.'.$this->get('_element');
        return $ns;
    }
     ...
     * @return array
     */
    function _getModel( $name = '', $prefix = 'MysiteModel', $config = array() )
    {
    	if (empty( $name ))
    	{
